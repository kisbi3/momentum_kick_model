...
//Ridge parameters
double a = 4.;    //fall off parameter
double T = .7;    //Temperature, GeV
double q = .7;    //GeV
...
double dphif_2 = double ((1.178097+1.178097)/n_2);  //func2 phi 출력 범위 : -1.28~1.28
double phif_2 = -1.178097;
double dphif_3 = double ((1.178097+1.178097)/n_3);  //func3 phi 출력 범위 : -1.28~1.28
double phif_3 = -1.178097;
double dphif_4 = double ((1.178097+1.178097)/n_4);  //func4 phi 출력 범위 : -1.28~1.28
double phif_4 = -1.178097;
double dphif_5 = double ((1.178097+1.178097)/n_5);  //func5 phi 출력 범위 : -1.28~1.28
double phif_5 = -1.178097;

double dphif_6 = double ((1.178097+1.178097)/n_6);  //func6 phi 출력 범위 : -1.28~1.28
double phif_6 = -1.178097;
    ...
    for(k_2=1;k_2<=n_2+1;k_2++){
        ...
        for(i_2=1;i_2<=n_2+1;i_2++){
            ...
            for(j_2=1;j_2<=n_2+1;j_2+=1){
                ...
                sum_2j += ptf_2*integralNjet(ptf_2,etaf_2,phif_2,constant)*dptf_2*detaf_2/delta_Deltaeta;
                // sum_2 *= frnk(ptf_2);
...
int main()
{
    ...
    thread t1(func1);    //pt distribution
