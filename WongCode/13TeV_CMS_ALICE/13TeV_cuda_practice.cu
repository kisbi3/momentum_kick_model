...
__global__ void saxpy(double Aridge, double ptf, double etaf, double phif, int check2_1, double qq){
...
void func10(double arr[], double ptf, double phif, double etaf, double etacms, double etajet, double qq, double dptff){
    int i;
    double delta_Deltaeta = 0.4;        //dx_1
    double delta_Deltaetacms = 4.;      //dx_2
                                        //dx_3 -> detajet
