...
CMS13TeVpt=np.loadtxt('/home/jaesung/Desktop/Dropbox/Code/WongCode/13TeV/HEPData-ins1397173-v1-csv/Table34.csv',delimiter=',',usecols=[0],skiprows=14,max_rows=4)
CMS13TeVptdis=np.loadtxt('/home/jaesung/Desktop/Dropbox/Code/WongCode/13TeV/HEPData-ins1397173-v1-csv/Table34.csv',delimiter=',',usecols=[1],skiprows=14,max_rows=4)
CMS13TeVptdis_error1_stat=np.loadtxt('/home/jaesung/Desktop/Dropbox/Code/WongCode/13TeV/HEPData-ins1397173-v1-csv/Table34.csv',delimiter=',',usecols=[2],skiprows=14,max_rows=4)
CMS13TeVptdis_error2_stat=np.loadtxt('/home/jaesung/Desktop/Dropbox/Code/WongCode/13TeV/HEPData-ins1397173-v1-csv/Table34.csv',delimiter=',',usecols=[3],skiprows=14,max_rows=4)
CMS13TeVptdis_error1_sys=np.loadtxt('/home/jaesung/Desktop/Dropbox/Code/WongCode/13TeV/HEPData-ins1397173-v1-csv/Table34.csv',delimiter=',',usecols=[4],skiprows=14,max_rows=4)
CMS13TeVptdis_error2_sys=np.loadtxt('/home/jaesung/Desktop/Dropbox/Code/WongCode/13TeV/HEPData-ins1397173-v1-csv/Table34.csv',delimiter=',',usecols=[5],skiprows=14,max_rows=4)
...
CMS13TeVpt_low = np.loadtxt('/home/jaesung/Desktop/Dropbox/Code/WongCode/13TeV/HEPData-ins1397173-v1-csv/Table34.csv',delimiter=',',usecols=[6],skiprows=14,max_rows=9)
CMS13TeVpt_high = np.loadtxt('/home/jaesung/Desktop/Dropbox/Code/WongCode/13TeV/HEPData-ins1397173-v1-csv/Table34.csv',delimiter=',',usecols=[7],skiprows=14,max_rows=9)
...
plt.errorbar(CMS13TeVpt, CMS13TeVptdis, yerr=(abs(CMS13TeVptdis_error2)*norm_CMS,CMS13TeVptdis_error1*norm_CMS), color="black",zorder=1,markersize=35,marker='^',linestyle=' ',linewidth=3,label=r'$pp, \, 7TeV, \, CMS$',capsize=10)
