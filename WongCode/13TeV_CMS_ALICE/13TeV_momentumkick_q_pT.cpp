...
double frconst = 2.;
double nkconst1 = 11.5;
double nkconst2 = 0.3;

double qpt1 = 1.5;
double qpt2 = 0.76;

// fr = exp(-frconst/pt_trig)
// q = qpt1*exp(-qpt2/pt_trig)
// nk = nkconst1*exp(-nkconst2*pt_trig)
...
double qpt(double pt_trig){
    return qpt1*exp(-qpt2/pt_trig);
}

double frnk(double pt_trig){
    double fr, nk;
    fr = exp(-frconst/pt_trig);
    nk = nkconst1*exp(-nkconst2*pt_trig);
    return fr*nk;
