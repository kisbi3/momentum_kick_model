...
double detaf_2 = double ((4.-2.)/n_2);  //func2 eta 적분 범위 : 4~2
double etaf0_2 = 2.;
double detaf_3 = double ((4.-2.)/n_3);  //func3 eta 적분 범위 : 4~2
double etaf0_3 = 2.;
double detaf_4 = double ((4.-2.)/n_4);  //func4 eta 적분 범위 : 4~2
double etaf0_4 = 2.;

double detaf_5 = double ((4.-2.)/n_5);  //func5 eta 적분 범위 : 4~2
double etaf0_5 = 2.;
