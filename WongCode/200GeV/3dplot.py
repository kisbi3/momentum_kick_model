...
# detaf_Jet_1=np.loadtxt('3dplot_Ridge_Jet~1.csv',delimiter=',',usecols=[0],skiprows=1)
# dphif_Jet_1=np.loadtxt('3dplot_Ridge_Jet~1.csv',delimiter=',',usecols=[1],skiprows=1)
# Ridge_Jet_1=np.loadtxt('3dplot_Ridge_Jet~1.csv',delimiter=',',usecols=[2],skiprows=1)

# detaf_Jet_13=np.loadtxt('3dplot_Ridge_Jet1~3.csv',delimiter=',',usecols=[0],skiprows=1)
# dphif_Jet_13=np.loadtxt('3dplot_Ridge_Jet1~3.csv',delimiter=',',usecols=[1],skiprows=1)
# Ridge_Jet_13=np.loadtxt('3dplot_Ridge_Jet1~3.csv',delimiter=',',usecols=[2],skiprows=1)
