...
resultphi=np.loadtxt('phiCorrelation_pt015-4.csv',delimiter=',',usecols=[0],skiprows=1)
resultdNdphi=np.loadtxt('phiCorrelation_pt015-4.csv',delimiter=',',usecols=[1],skiprows=1)
resultJet=np.loadtxt('phiCorrelation_pt015-4.csv',delimiter=',',usecols=[2],skiprows=1)
dNdphimin=min(resultdNdphi)
Ridge_Jetmin = min(resultdNdphi+resultJet)

# plt.errorbar(deltaphitable26,dNdphitable26-datamintable26, yerr=(table26_error1,abs(table26_error2)), color="blue",markersize=15,marker='o',linestyle=' ',linewidth=3,label=r'$pp,13TeV \, CMS$',capsize=10)
# ,fillstyle='none'
...
fig.savefig('phiCorrelation_pt015-4.png')
...
resultphi=np.loadtxt('phiCorrelation_pt2-4.csv',delimiter=',',usecols=[0],skiprows=1)
resultdNdphi=np.loadtxt('phiCorrelation_pt2-4.csv',delimiter=',',usecols=[1],skiprows=1)
resultJet=np.loadtxt('phiCorrelation_pt2-4.csv',delimiter=',',usecols=[2],skiprows=1)
dNdphimin=min(resultdNdphi)
Ridge_Jetmin = min(resultdNdphi+resultJet)
...
# plt.errorbar(deltaphitable28,dNdphitable28-datamintable28, yerr=(table28_error1,abs(table28_error2)), color="blue",markersize=15,marker='o',linestyle=' ',linewidth=3,label=r'$pp,13TeV \, CMS$',capsize=10)
# ,fillstyle='none'
# plt.scatter(deltaphi,dNdphi, color="black", s = 80)
# plt.plot(deltaphi,dNdphi-datamin, color="blue", linestyle = '', linewidth = 13)
plt.plot(resultphi, resultdNdphi, color = 'red', linewidth=7, linestyle = '--',label=r'$Ridge$')
...
# plt.title(r'$1.0<p_T<2.0 \quad N_{trk}^{offline}\geq105,\quad C_{ZYAM}=1.27,\quad \Delta\phi_{ZYAM}=1.18$', fontsize = 60)
plt.title(r'$2.0<p_T<4.0$', fontsize = 60)
plt.minorticks_on()
# plt.yscale('log')
# ax.axis([-0.1,3.1,0,0.1])
...
fig.savefig('phiCorrelation_pt2-4.png')
...
resultphi=np.loadtxt('etaCorrelation_pt015-4.csv',delimiter=',',usecols=[0],skiprows=1)
resultdNdphi=np.loadtxt('etaCorrelation_pt015-4.csv',delimiter=',',usecols=[1],skiprows=1)
resultJet=np.loadtxt('etaCorrelation_pt015-4.csv',delimiter=',',usecols=[2],skiprows=1)
dNdphimin=min(resultdNdphi)
Ridge_Jetmin = min(resultdNdphi+resultJet)
...
# plt.errorbar(deltaphitable30,dNdphitable30-datamintable30, yerr=(table30_error1,abs(table30_error2)), color="blue",markersize=15,marker='o',linestyle=' ',linewidth=3,label=r'$pp,13TeV \, CMS$',capsize=10)
# ,fillstyle='none'
# plt.scatter(deltaphi,dNdphi, color="black", s = 80)
# plt.plot(deltaphi,dNdphi-datamin, color="blue", linestyle = '', linewidth = 13)
plt.plot(resultphi, resultdNdphi, color = 'red', linewidth=7, linestyle = '--',label=r'$Ridge$')
...
plt.xlabel(r'$\Delta\eta$',size=50)
plt.ylabel(r'$\frac{1}{N_{trig}}\frac{dN_{ch}}{d\Delta\eta}$',size=50)
...
fig.savefig('etaCorrelation_pt015-4.png')
...
resultphi=np.loadtxt('etaCorrelation_pt2-4.csv',delimiter=',',usecols=[0],skiprows=1)
resultdNdphi=np.loadtxt('etaCorrelation_pt2-4.csv',delimiter=',',usecols=[1],skiprows=1)
resultJet=np.loadtxt('etaCorrelation_pt2-4.csv',delimiter=',',usecols=[2],skiprows=1)
dNdphimin=min(resultdNdphi)
Ridge_Jetmin = min(resultdNdphi+resultJet)
...
# plt.errorbar(deltaphitable32,dNdphitable32-datamintable32, yerr=(table32_error1,abs(table32_error2)), color="blue",markersize=15,marker='o',linestyle=' ',linewidth=3,label=r'$pp,13TeV \, CMS$',capsize=10)
# ,fillstyle='none'
# plt.scatter(deltaphi,dNdphi, color="black", s = 80)
# plt.plot(deltaphi,dNdphi-datamin, color="blue", linestyle = '', linewidth = 13)
plt.plot(resultphi, resultdNdphi, color = 'red', linewidth=7, linestyle = '--',label=r'$Ridge$')
...
fig.savefig('etaCorrelation_pt2-4.png')
...
# plt.errorbar(deltaphi_pt14,dNdphi_pt14-mindNdphi_pt14, yerr=((table28_error1**2+table30_error1**2+table32_error1**2)**0.5,(table28_error2**2+table30_error2**2+table32_error2**2)**0.5), color="blue",markersize=15,marker='o',linestyle=' ',linewidth=3,label=r'$pp,13TeV \, CMS$',capsize=10)
# # ,fillstyle='none'
# # plt.scatter(deltaphi,dNdphi, color="black", s = 80)
# # plt.plot(deltaphi,dNdphi-datamin, color="blue", linestyle = '', linewidth = 13)
