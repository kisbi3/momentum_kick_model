#이 파일은 q가 multiplicity dependence가 없는 경우이다.
...
# print(theory_norm)
# 귀찮아서 그냥 값 뽑아서 복붙.
theory_norm = {0.05285182774-(2*min(atlas_result))}

ratio_95 = norm_templ_95/theory_norm
ratio_105 = norm_templ_105/theory_norm
ratio_115 = norm_templ_115/theory_norm
ratio_125 = norm_templ_125/theory_norm
ratio_135 = norm_templ_135/theory_norm
...
plt.plot(atlas_phi, (atlas_result-min(atlas_result))*ratio_95, color = 'grey', linewidth=5, linestyle = '-',label=r'$90 \,\, \leq N_{ch}^{rec}<100$')
plt.plot(atlas_phi, (atlas_result-min(atlas_result))*ratio_105, color = 'blue', linewidth=5, linestyle = '-',label=r'$100 \leq N_{ch}^{rec}<110$')
plt.plot(atlas_phi, (atlas_result-min(atlas_result))*ratio_115, color = 'orange', linewidth=5, linestyle = '-',label=r'$110 \leq N_{ch}^{rec}<120$')
plt.plot(atlas_phi, (atlas_result-min(atlas_result))*ratio_125, color = 'green', linewidth=5, linestyle = '-',label=r'$120 \leq N_{ch}^{rec}<130$')
plt.plot(atlas_phi, (atlas_result-min(atlas_result))*ratio_135, color = 'black', linewidth=5, linestyle = '-',label=r'$130 \leq N_{ch}^{rec}$')
...
theory_130_up = (atlas_result-min(atlas_result))*ratio_135-F_result[1]*periph(atlas_phi, *popt_periph_130TeV)
theory_120_130 = (atlas_result-min(atlas_result))*ratio_125-F_result[2]*periph(atlas_phi, *popt_periph_130TeV)
theory_110_120 = (atlas_result-min(atlas_result))*ratio_115-F_result[3]*periph(atlas_phi, *popt_periph_130TeV)
theory_100_110 = (atlas_result-min(atlas_result))*ratio_105-F_result[4]*periph(atlas_phi, *popt_periph_130TeV)
theory_90_100 = (atlas_result-min(atlas_result))*ratio_95-F_result[5]*periph(atlas_phi, *popt_periph_130TeV)
